...
### Técnico em Informática formado pelo IF 🎓

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=FFFFFF&center=true&vCenter=true&width=435&lines=Full+Stack+Developer+Enthusiast;React+|+Next.js+|+Node.js;Sempre+aprendendo+algo+novo...;Apaixonado+por+Linux+%26+Open+Source" alt="Typing SVG" />
...
| :--- | :--- | :--- |
| [**ObservaDH**](https://github.com/nexus-ifal/ObservaDH) | Plataforma de observatório de dados. | `Next.js` `TypeScript` `Prisma` |
| [**Post Installation Zorin**](https://github.com/follijulio/post-installation-zorin) | Automação de setup para Linux Zorin OS. | `Shell Script` `Linux` |
